...
Luego de hacer el git clone
ir a la carpeta del repositorio

cd cuadros

## Istalar framework y dependencias
...
## PARA ACCEDER A LA API LOS REQUESTS TIENEN QUE TENER EL HEADER X-HTTP-USER-ID = 1

## POSTMAN REQUESTS COLLECTIONS

Esta en la raiz del proyecto el archivo

CUADROS.postman_collection.json